...
void HIDScreen::reconfigure(UInt32 activeSides) {
    // TODO
}

void HIDScreen::warpCursor(SInt32 x, SInt32 y) {
    // TODO
}

UInt32 HIDScreen::registerHotKey(KeyID key, KeyModifierMask mask) {
    return 0;
}

void HIDScreen::unregisterHotKey(UInt32 id) {
    // TODO
}
